...
func spawn_bread(position: Vector2) -> void:
	var load_of_bread_scene = load("res://pickups/load_of_bread.tscn")
...
func spawn_acorn(position: Vector2) -> void:
	var acorn_powerup_scene = load("res://pickups/acorn_powerup.tscn")
...
func spawn_ring(position: Vector2) -> void:
	var rainbow_ring_scene = load("res://pickups/rainbow_ring.tscn")
